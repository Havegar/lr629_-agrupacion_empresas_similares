...
malla_noduplicados=spark.sql('select RUT_SOCIEDAD, RUT_SOCIO, PORCENTAJE_CAPITAL/100 as peso from malla_societaria ')
...
df_entidades_final.to_csv('/home/cdsw/data/processed/louvain_malla_societaria_pesos/louvain_malla_societaria_pesos.csv', index=False)
...
df_resolucion_modularidad.to_csv('/home/cdsw/data/processed/louvain_malla_societaria_pesos/resolucion_modularidad_sociedad_pesos.csv', index=False)
