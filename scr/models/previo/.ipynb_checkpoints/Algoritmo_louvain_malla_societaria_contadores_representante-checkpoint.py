...
spark.sql('SELECT repr_fecha_inicio_vo,cont_rut,cont_rut_representante,repr_fecha_termino_vo from dw.dw_trn_djr_representantes_e limit 1000').createOrReplaceTempView("data_rep")
...
df_relaciones_representante=spark.sql('select * from data_rep').toPandas()
...
# cargamos relaciones, con nodos cont y cont_rut_repesentante
