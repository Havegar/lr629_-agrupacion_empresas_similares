...
nx.write_graphml(subgraph, "/home/cdsw/data/processed/subgrafo/muestreo_centralidad_gridsearch/subgraph_filtrado.graphml")

with open('/home/cdsw/data/processed/subgrafo/muestreo_centralidad_gridsearch/membership.json', 'w') as json_file:
    json.dump(membership, json_file)
    
with open('/home/cdsw/data/processed/subgrafo/muestreo_centralidad_gridsearch/diccionario_grupos_muestra.json', 'w') as json_file:
